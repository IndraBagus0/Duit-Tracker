                        ...
                        <form method="post" action="/">
                            ...
                            <div class="form-group position-relative has-icon-left mb-4">
                                <input type="text" name="email"
                                    class="form-control  @error('email') form-control-xl @enderror" placeholder="Email">
                            ...
                            <div class="form-group position-relative has-icon-left mb-4">
                                <input type="password" name="password"
                                    class="form-control @error('password') form-control-xl @enderror"
                            ...
                            <div class="text-center mt-5 text-lg fs-4">
                                <p class="text-gray-600">Belum punya akun? <a href="/register" class="font-bold">Buat
                                        Akun?</a></p>
