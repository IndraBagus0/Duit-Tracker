                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            value="{{ $user->email }}" id="email-id-icon" readonly>
                                                        <div class="form-control-icon">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control"
                                                            value="{{ $user->phoneNumber }}" id="mobile-id-icon"
                                                            name="phoneNumber">
                                                        <div class="form-control-icon">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <span
                                                            class="badge {{ $user->roleId == 2 ? 'bg-primary' : ($user->roleId == 3 ? 'bg-success' : 'bg-primary') }}">
                                                            {{ $user->roleId == 2 ? 'Free Member' : ($user->roleId == 3 ? 'Premium Member' : 'Free Member') }}
                                                        </span>
                                                        @if ($user->roleId == 2)
                                                            <a href="{{ route('profile.upgrade') }}"
                                                                class="badge bg-warning ms-2">Upgrade</a>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
